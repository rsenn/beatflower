...
#ifndef BEATFLOWER_RENDERER_SDL_H__
#define BEATFLOWER_RENDERER_SDL_H__ 1

/* beatflower_renderer_sdl.c */
void beatflower_renderer_sdl_init(void);
void *beatflower_renderer_sdl_thread(void *blah);

#endif // BEATFLOWER_RENDERER_SDL_H__ 1
