...
void on_mode_option_changed(GtkMenuItem *item, GtkMenu *menu)
{
  GtkWidget *active;
  gint32     index;
...
void on_draw_option_changed(GtkMenuItem *item, GtkMenu *menu)
{
  GtkWidget *active;
  gint32     index;
...
void on_samples_option_changed(GtkMenuItem *item, GtkMenu *menu)
{
  GtkWidget *active;
  gint32     index;
...
void on_amplification_option_changed(GtkMenuItem *item, GtkMenu *menu)
{
  GtkWidget *active;
  gint32     index;
...
void on_offset_option_changed(GtkMenuItem *item, GtkMenu *menu)
{
  GtkWidget *active;
  gint32     index;
...
beatflower_xmms_settings(void)
{
  ...
  // GtkSpinButton: config.factor
  factor_spinbutton_adj = gtk_adjustment_new(beatflower_newconfig.factor, 0.5, 2, 0.001, 0.01, 1.5);
  factor_spinbutton = gtk_spin_button_new(GTK_ADJUSTMENT(factor_spinbutton_adj), 0.01, 3);
  gtk_widget_ref(factor_spinbutton);
  gtk_object_set_data_full(GTK_OBJECT(beatflower_xmms_settings_win), "factor_spinbutton", factor_spinbutton,
                           (GtkDestroyNotify) gtk_widget_unref);
  gtk_widget_show(factor_spinbutton);
